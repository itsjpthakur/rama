...
from rama.config import *  # noqa: F403
from rama.config import DATA_DIR
from tests.integration_tests.rama_test_custom_template_processors import (
...
if "RAMA__SQLALCHEMY_DATABASE_URI" in os.environ:  # noqa: F405
    SQLALCHEMY_DATABASE_URI = os.environ["RAMA__SQLALCHEMY_DATABASE_URI"]  # noqa: F405

SQLALCHEMY_EXAMPLES_URI = SQLALCHEMY_DATABASE_URI
if "RAMA__SQLALCHEMY_EXAMPLES_URI" in os.environ:  # noqa: F405
    SQLALCHEMY_EXAMPLES_URI = os.environ["RAMA__SQLALCHEMY_EXAMPLES_URI"]  # noqa: F405
...
if make_url(SQLALCHEMY_DATABASE_URI).get_backend_name() == "sqlite":
    logger.warning(  # noqa: F405
        ...
        "removed in a future version of Rama."
    )
...
DATA_CACHE_CONFIG = {
    **CACHE_CONFIG,
    ...
    "CACHE_KEY_PREFIX": "rama_data_cache",
}
