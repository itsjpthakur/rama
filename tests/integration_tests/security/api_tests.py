...
class TestSecurityCsrfApi(RamaTestCase):
...
class TestSecurityGuestTokenApi(RamaTestCase):
...
class TestSecurityGuestTokenApiTokenValidator(RamaTestCase):
    uri = "api/v1/security/guest_token/"
...
class TestSecurityRolesApi(RamaTestCase):
