...
class TestPrestoDbEngineSpec(TestDbEngineSpec):
    ...
    @mock.patch("rama.db_engine_specs.base.BaseEngineSpec.get_table_names")
    @mock.patch("rama.db_engine_specs.presto.PrestoEngineSpec.get_view_names")
    ...
    @mock.patch("rama.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    @mock.patch("rama.db_engine_specs.presto.is_feature_enabled")
    @mock.patch("rama.db_engine_specs.base.BaseEngineSpec.select_star")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.COLUMN_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.TABLE_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.SCHEMA_DOES_NOT_EXIST_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.CONNECTION_ACCESS_DENIED_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.CONNECTION_HOST_DOWN_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "Presto",
                    "issue_codes": [
