...
class TestBigQueryDbEngineSpec(TestDbEngineSpec):
    ...
    @mock.patch("rama.db_engine_specs.bigquery.BigQueryEngineSpec.get_engine")
    @mock.patch("rama.db_engine_specs.bigquery.pandas_gbq")
    @mock.patch("rama.db_engine_specs.bigquery.service_account")
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            RamaError(
                ...
                error_type=RamaErrorType.CONNECTION_DATABASE_PERMISSIONS_ERROR,
    ...
    @mock.patch("rama.models.core.Database.db_engine_spec", BigQueryEngineSpec)
