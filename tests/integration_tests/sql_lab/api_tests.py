...
from rama import db, sql_lab
from rama.common.db_query_status import QueryStatus
from rama.models.core import Database  # noqa: F401
from rama.utils.database import get_example_database, get_main_database  # noqa: F401
...
class TestSqlLabApi(RamaTestCase):
    ...
    def test_get_access_denied(self):
        ...
        unauth_user = self.create_user(
            ...
            "password",
            "Dummy Role",
            email="unauth_user1@rama.org",  # noqa: F541
        )
    ...
    @mock.patch("rama.commands.sql_lab.results.results_backend_use_msgpack", False)
    ...
    def test_execute_valid_request(self) -> None:
        from rama import sql_lab as core
    ...
    @mock.patch(
        "tests.integration_tests.rama_test_custom_template_processors.datetime"
    )
    @mock.patch("rama.sqllab.api.get_sql_results")
    ...
    def test_get_results_with_display_limit(self):
        from rama.commands.sql_lab import results as command
        ...
        with mock.patch("rama.commands.sql_lab.results.db") as mock_rama_db:
            mock_rama_db.session.query().filter_by().one_or_none.return_value = (
                query_mock
            )
            # get all results
            arguments = {"key": "key"}
    ...
    @mock.patch("rama.models.sql_lab.Query.raise_for_access", lambda _: None)  # noqa: PT008
    @mock.patch("rama.models.core.Database.get_df")
