...
from rama.commands.report.exceptions import AlertQueryError
from rama.reports.models import ReportCreationMethod, ReportScheduleType
...
def test_execute_query_as_report_executor(
    ...
    override_user_mock = mocker.patch("rama.commands.report.alert.override_user")
    cm = (
...
def test_execute_query_mutate_query_enabled(
    ...
    mocker.patch("rama.commands.report.alert.override_user")
...
def test_execute_query_succeeded_no_retry(
    ...
    execute_query_mock = mocker.patch(
        "rama.commands.report.alert.AlertCommand._execute_query",
...
def test_execute_query_succeeded_with_retries(
    ...
    from rama.commands.report.alert import AlertCommand, AlertQueryError
    ...
    # Should match the value defined in rama_test_config.py
...
def test_execute_query_failed_no_retry(
    ...
    from rama.commands.report.alert import AlertCommand, AlertQueryTimeout
