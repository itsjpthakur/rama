...
from rama.reports.models import ReportScheduleType
from rama.tasks.scheduler import execute, scheduler
...
@patch("rama.tasks.scheduler.execute.apply_async")
...
@pytest.mark.usefixtures("app_context")
@patch("rama.commands.report.execute.AsyncExecuteReportScheduleCommand.__init__")
@patch("rama.commands.report.execute.AsyncExecuteReportScheduleCommand.run")
@patch("rama.tasks.scheduler.execute.update_state")
def test_execute_task(update_state_mock, command_mock, init_mock, owners):
    from rama.commands.report.exceptions import ReportScheduleUnexpectedError
