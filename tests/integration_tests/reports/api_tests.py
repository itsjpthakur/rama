...
class TestReportSchedulesApi(RamaTestCase):
    @pytest.fixture
    def gamma_user_with_alerts_role(self):
        with self.create_app().app_context():
            user = self.create_user(
                ...
                "general",
                "Gamma",
                email=f"{REPORTS_GAMMA_USER}@rama.org",
            )
    ...
    def test_create_report_schedule(self):
        ...
        report_schedule_data = {
            ...
            "recipients": [
                {
                    "type": ReportRecipientType.EMAIL,
                    "recipient_config_json": {"target": "target@rama.org"},
                },
                {
    ...
    def test_create_report_schedule_valid_schedule(self):
        ...
        with patch.dict(
            "rama.commands.report.base.current_app.config",
            {
