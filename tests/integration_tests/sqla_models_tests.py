...
from rama import db
from rama.connectors.sqla.models import SqlaTable, TableColumn, SqlMetric
from rama.constants import EMPTY_STRING, NULL_STRING
from rama.db_engine_specs.bigquery import BigQueryEngineSpec
from rama.db_engine_specs.druid import DruidEngineSpec
...
class TestDatabaseModel(RamaTestCase):
    ...
    @patch("rama.jinja_context.get_username", return_value="abc")
    ...
    @patch("rama.jinja_context.get_dataset_id_from_context")
    ...
    @patch("rama.models.core.Database.db_engine_spec", BigQueryEngineSpec)
...
@patch("rama.jinja_context.get_user_id", return_value=1)
@patch("rama.jinja_context.get_username", return_value="abc")
@patch("rama.jinja_context.get_user_email", return_value="abc@test.com")
