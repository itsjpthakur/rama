...
from rama.commands.dashboard.update import UpdateDashboardCommand
from rama.models.dashboard import Dashboard
from rama.utils.json import dumps
...
@patch("rama.commands.dashboard.update.send_email_smtp")
@patch.dict(
