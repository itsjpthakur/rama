...
from rama.commands.database.exceptions import DatabaseInvalidError
...
from rama.constants import NO_TIME_RANGE
from rama.exceptions import CertificateException, RamaException  # noqa: F401
from rama.models.core import Database, Log
from rama.models.dashboard import Dashboard  # noqa: F401
from rama.models.slice import Slice  # noqa: F401
...
from rama.utils.database import get_or_create_db
from rama.utils import schema
from rama.utils.hashing import md5_sha_from_str
from rama.views.utils import build_extra_filters, get_form_data  # noqa: F401
...
class TestUtils(RamaTestCase):
    ...
    def test_get_or_create_db(self):
        get_or_create_db("test_db", "sqlite:///rama.db")
        database = db.session.query(Database).filter_by(database_name="test_db").one()
        assert database is not None
        assert database.sqlalchemy_uri == "sqlite:///rama.db"
        assert (
    ...
    def test_get_or_create_db_invalid_uri(self):
        with self.assertRaises(DatabaseInvalidError):  # noqa: PT027
            get_or_create_db("test_db", "yoursql:rama.db/()")

    def test_get_or_create_db_existing_invalid_uri(self):
        database = get_or_create_db("test_db", "sqlite:///rama.db")
    ...
    def test_log_this(self) -> None:
        ...
        resp = self.get_json_resp(  # noqa: F841
            f"/rama/explore_json/{slc.datasource_type}/{slc.datasource_id}/"
