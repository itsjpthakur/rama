...
from rama.models import core as models  # noqa: F401
from rama.utils.core import get_user_id, get_username, override_user
...
EXTEND_ROLE_REQUEST = (
    "/rama/approve?datasource_type={}&datasource_id={}&"
...
def test_get_user_id(
    ...
    mock_g = mocker.patch("rama.utils.core.g", spec={})
