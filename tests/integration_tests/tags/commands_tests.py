...
from rama.commands.dashboard.exceptions import DashboardNotFoundError  # noqa: F401
...
from rama.commands.dashboard.importers import v0, v1  # noqa: F401
from rama.commands.exceptions import CommandInvalidError  # noqa: F401
from rama.commands.importers.exceptions import IncorrectVersionError  # noqa: F401
from rama.commands.tag.create import CreateCustomTagCommand
from rama.commands.tag.delete import DeleteTaggedObjectCommand, DeleteTagsCommand
...
# test create command
class TestCreateCustomTagCommand(RamaTestCase):
...
class TestDeleteTagsCommand(RamaTestCase):
    @pytest.mark.usefixtures("load_world_bank_dashboard_with_slices")
    @pytest.mark.usefixtures("with_tagging_system_feature")
...
class TestDeleteTaggedObjectCommand(RamaTestCase):
    @pytest.mark.usefixtures("load_world_bank_dashboard_with_slices")
    @pytest.mark.usefixtures("with_tagging_system_feature")
    def test_delete_tags_command(self):
