...
from rama.models.sql_lab import SavedQuery  # noqa: F401
from rama.tags.models import user_favorite_tag_table  # noqa: F401
...
from rama.common.db_query_status import QueryStatus  # noqa: F401
...
from rama.tags.models import ObjectType, Tag, TagType, TaggedObject
...
from rama.tags.models import ObjectType  # noqa: F811
...
class TestTagApi(RamaTestCase):
    ...
    def test_delete_favorite_tag(self):
        ...
        from rama.tags.models import user_favorite_tag_table  # noqa: F811
