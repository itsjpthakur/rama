...
from rama.tags.exceptions import InvalidTagNameError  # noqa: F401
from rama.tags.models import ObjectType, Tag, TaggedObject
...
from rama.daos.dashboard import DashboardDAO  # noqa: F401
...
class TestTagsDAO(RamaTestCase):
    def insert_tag(
        self,
        name: str,
        tag_type: str,
