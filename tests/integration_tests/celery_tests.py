...
# under the License.
# isort:skip_file
"""Unit tests for Rama Celery worker"""
...
from rama.sql_parse import ParsedQuery, CtasMethod
...
def test_default_data_serialization():
    ...
    results = RamaResultSet(SERIALIZATION_DATA, CURSOR_DESCR, db_engine_spec)
