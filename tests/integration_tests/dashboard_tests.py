...
class TestDashboard(RamaTestCase):
    @pytest.fixture
    ...
    def test_rama_dashboard_url(self):
        url_for("Rama.dashboard", dashboard_id_or_slug=1)
    ...
    def test_new_dashboard(self):
        ...
        group = re.match(
            r"\/rama\/dashboard\/([0-9]*)\/\?edit=true",
    ...
    def test_public_user_dashboard_access(self):
        ...
        assert "/rama/dashboard/births/" not in resp
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        assert "/rama/dashboard/births/" in resp
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        assert "/rama/dashboard/world_health/" not in resp
    ...
    def test_dashboard_with_created_by_can_be_accessed_by_public_users(self):
        ...
        res: Response = self.client.get("/rama/dashboard/births/")
    ...
    def test_users_can_list_published_dashboard(self):
        ...
        resp = self.get_resp("/api/v1/dashboard/")
        assert f"/rama/dashboard/{pytest.hidden_dash_slug}/" not in resp
        assert f"/rama/dashboard/{pytest.published_dash_slug}/" in resp
    ...
    def test_users_can_view_own_dashboard(self):
        ...
        assert f"/rama/dashboard/{my_dash_slug}/" in resp
        assert f"/rama/dashboard/{not_my_dash_slug}/" not in resp
    ...
    def test_user_can_not_view_unpublished_dash(self):
        ...
        assert f"/rama/dashboard/{slug}/" not in resp
