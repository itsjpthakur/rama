...
from rama.utils.pandas_postprocessing.utils import FLAT_COLUMN_SEPARATOR
...
class TestQueryContext(RamaTestCase):
    ...
    @pytest.mark.usefixtures("load_birth_names_dashboard_with_slices")
    @patch("rama.common.query_context.QueryContext.get_query_result")
