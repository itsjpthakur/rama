...
@mock.patch("rama.tasks.cache.fetch_csrf_token")
@mock.patch("rama.tasks.cache.request.Request")
@mock.patch("rama.tasks.cache.request.urlopen")
@mock.patch("rama.tasks.cache.is_secure_url")
def test_fetch_url(
    mock_is_secure_url,
    mock_urlopen,
    mock_request_cls,
    ...
    from rama.tasks.cache import fetch_url
