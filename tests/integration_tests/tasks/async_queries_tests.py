...
# under the License.
"""Unit tests for async query celery jobs in Rama"""
...
from rama.extensions import async_query_manager, security_manager
...
class TestAsyncQueries(RamaTestCase):
    ...
    @mock.patch("rama.tasks.async_queries.set_form_data")
    @mock.patch.object(async_query_manager, "update_job")
    def test_load_chart_data_into_cache(
        self, cache_type, cache_backend, mock_update_job, mock_set_form_data
    ):
        from rama.tasks.async_queries import load_chart_data_into_cache
    ...
    def test_soft_timeout_load_chart_data_into_cache(
        ...
        with pytest.raises(SoftTimeLimitExceeded):  # noqa: PT012
            with mock.patch(
                "rama.tasks.async_queries.set_form_data"
            ) as set_form_data:
    ...
    def test_load_explore_json_into_cache(
        ...
        from rama.tasks.async_queries import load_explore_json_into_cache
