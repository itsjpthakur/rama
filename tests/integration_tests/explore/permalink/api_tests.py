...
from rama import db
from rama.explore.permalink.schemas import ExplorePermalinkSchema
from rama.key_value.models import KeyValueEntry
from rama.key_value.types import KeyValueResource, MarshmallowKeyValueCodec
from rama.key_value.utils import decode_permalink_id, encode_permalink_key
...
def permalink_salt() -> Iterator[str]:
    from rama.key_value.shared_entries import get_permalink_salt, get_uuid_namespace
    from rama.key_value.types import SharedKey
