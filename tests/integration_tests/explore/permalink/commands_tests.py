...
class TestCreatePermalinkDataCommand(RamaTestCase):
    @pytest.fixture
    ...
    @patch("rama.security.manager.g")
    @patch("rama.daos.key_value.KeyValueDAO.get_value")
    @patch("rama.commands.explore.permalink.get.decode_permalink_id")
    @pytest.mark.usefixtures("create_dataset", "create_slice")
