...
from rama.explore.exceptions import DatasetAccessDeniedError
...
@patch("rama.security.RamaSecurityManager.can_access_datasource")
...
@patch("rama.daos.datasource.DatasourceDAO.get_datasource")
