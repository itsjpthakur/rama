...
from rama import app  # noqa: F401
from rama.commands.dataset.exceptions import DatasetCreateFailedError
from rama.connectors.sqla.models import SqlaTable, SqlMetric, TableColumn
from rama.extensions import db, security_manager
from rama.models.core import Database
from rama.models.slice import Slice
from rama.utils import json
from rama.utils.core import backend, get_example_default_schema
from rama.utils.database import get_example_database, get_main_database
from rama.utils.dict_import_export import export_to_dict
...
class TestDatasetApi(RamaTestCase):
    ...
    @patch("rama.models.core.Database.get_columns")
    @patch("rama.models.core.Database.has_table")
    @patch("rama.models.core.Database.has_view")
    @patch("rama.models.core.Database.get_table")
    ...
    @patch("rama.daos.dataset.DatasetDAO.create")
    ...
    @patch("rama.daos.dataset.DatasetDAO.update")
    ...
    @patch("rama.daos.dataset.DatasetDAO.delete")
    ...
    @pytest.mark.usefixtures("create_datasets")
    @patch("rama.daos.dataset.DatasetColumnDAO.delete")
    ...
    @pytest.mark.usefixtures("create_datasets")
    @patch("rama.daos.dataset.DatasetMetricDAO.delete")
    ...
    @patch("rama.commands.dataset.create.CreateDatasetCommand.run")
