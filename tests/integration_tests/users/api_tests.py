...
from rama.utils import json, slack  # noqa: F401
...
class TestCurrentUserApi(RamaTestCase):
...
class TestUserApi(RamaTestCase):
    ...
    @patch("rama.views.users.api.get_user_avatar", return_value=AVATAR_URL)
