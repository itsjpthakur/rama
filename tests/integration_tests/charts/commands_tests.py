...
from rama.commands.chart.importers.v1 import ImportChartsCommand
...
class TestExportChartsCommand(RamaTestCase):
...
class TestImportChartsCommand(RamaTestCase):
...
class TestChartsCreateCommand(RamaTestCase):
    @patch("rama.utils.core.g")
    @patch("rama.commands.chart.create.g")
    @patch("rama.security.manager.g")
    @pytest.mark.usefixtures("load_energy_table_with_slice")
...
class TestChartsUpdateCommand(RamaTestCase):
    @patch("rama.commands.chart.update.g")
    @patch("rama.utils.core.g")
    @patch("rama.security.manager.g")
    @pytest.mark.usefixtures("load_energy_table_with_slice")
...
class TestChartWarmUpCacheCommand(RamaTestCase):
...
class TestFavoriteChartCommand(RamaTestCase):
    @pytest.mark.usefixtures("load_energy_table_with_slice")
    ...
    @pytest.mark.usefixtures("load_energy_table_with_slice")
    @patch("rama.daos.base.BaseDAO.find_by_id")
