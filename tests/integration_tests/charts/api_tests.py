...
from rama.extensions import cache_manager, db, security_manager
from rama.models.core import Database, FavStar, FavStarClassName
...
from rama.tags.models import ObjectType, Tag, TaggedObject, TagType
...
class TestChartApi(ApiOwnersTestCaseMixin, InsertChartMixin, RamaTestCase):
    resource_name = "chart"
    ...
    def test_update_chart(self):
        ...
        birth_names_table_id = RamaTestCase.get_table(name="birth_names").id
    ...
    @patch("rama.security.manager.RamaSecurityManager.has_guest_access")
    @patch("rama.security.manager.RamaSecurityManager.is_guest_user")
    @pytest.mark.usefixtures("load_birth_names_dashboard_with_slices")
