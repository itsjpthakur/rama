...
@mock.patch("rama.tasks.async_queries.security_manager")
@mock.patch("rama.tasks.async_queries.async_query_manager")
@mock.patch("rama.tasks.async_queries.ChartDataQueryContextSchema")
