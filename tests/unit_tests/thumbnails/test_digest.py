...
from rama.tasks.exceptions import InvalidExecutorError
from rama.tasks.types import Executor, ExecutorType, FixedExecutor
...
def test_dashboard_digest(
    ...
    from rama import app, security_manager
    from rama.models.dashboard import Dashboard
    from rama.models.slice import Slice
