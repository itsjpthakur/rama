...
from rama.commands.report.execute import BaseReportState
...
from rama.utils.core import HeaderDataType
from rama.utils.screenshots import ChartScreenshot
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            ["url1", "url2"],
            [
                "http://0.0.0.0:8080/rama/dashboard/p/url1/",
                "http://0.0.0.0:8080/rama/dashboard/p/url2/",
            ],
        ),
...
@patch(
    "rama.commands.dashboard.permalink.create.CreateDashboardPermalinkCommand.run"
)
...
def test_get_dashboard_urls_with_exporting_dashboard_only(
    ...
    assert "http://0.0.0.0:8080/rama/dashboard/p/url1/" == result[0]
...
def test_get_tab_urls(
    ...
    assert result == [
        "http://0.0.0.0:8080/rama/dashboard/p/uri1/",
        "http://0.0.0.0:8080/rama/dashboard/p/uri2/",
    ]
...
def test_get_tab_url(
    ...
    assert result == "http://0.0.0.0:8080/rama/dashboard/p/uri/"
...
def test_screenshot_width_calculation(
    ...
    with (
        patch(
            "rama.commands.report.execute.security_manager"
        ) as mock_security_manager,
        patch(
            "rama.utils.screenshots.ChartScreenshot.get_screenshot"
