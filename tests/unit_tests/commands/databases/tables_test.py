...
from rama.utils.core import DatasourceName
...
def database_with_catalog(mocker: MockerFixture) -> MagicMock:
    ...
    """
    mocker.patch("rama.commands.database.tables.db")
    ...
    DatabaseDAO = mocker.patch("rama.commands.database.tables.DatabaseDAO")  # noqa: N806
...
def test_tables_with_catalog(
    ...
    db = mocker.patch("rama.commands.database.tables.db")
