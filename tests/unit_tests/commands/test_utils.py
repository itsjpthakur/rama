...
from rama.commands.exceptions import TagForbiddenError, TagNotFoundValidationError
from rama.commands.utils import (
    compute_owner_list,
    populate_owner_list,
    Tag,
    TagType,
...
@patch("rama.commands.utils.g")
@patch("rama.commands.utils.security_manager")
@patch("rama.commands.utils.get_user_id")
...
@patch("rama.commands.utils.populate_owner_list")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("rama.commands.utils.security_manager")
@patch("rama.commands.utils.TagDAO.find_by_id")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("rama.commands.utils.security_manager")
@patch("rama.commands.utils.TagDAO.find_by_name")
...
@pytest.mark.parametrize("object_type", OBJECT_TYPES)
@patch("rama.commands.utils.TagDAO")
