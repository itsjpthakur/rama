...
from rama.reports.notifications.slackv2 import SlackV2Notification
...
def test_get_channel_with_multi_recipients(mock_header_data) -> None:
    ...
    """
    from rama.reports.models import ReportRecipients, ReportRecipientType
    from rama.reports.notifications.base import NotificationContent
    from rama.reports.notifications.slack import SlackNotification
...
@patch("rama.reports.notifications.slackv2.g")
@patch("rama.reports.notifications.slackv2.logger")
...
def test_send_slackv2(
    ...
    # `rama.models.helpers`, a dependency of following imports,
...
@patch("rama.reports.notifications.slack.g")
@patch("rama.reports.notifications.slack.logger")
