...
from rama.rama_typing import ResultSetColumnType, SQLAColumnType
...
def test_get_column_spec(
    ...
    from rama.db_engine_specs.databricks import (
...
def test_convert_inspector_columns(
    ...
    from rama.db_engine_specs.base import convert_inspector_columns
...
def test_extra_table_metadata(mocker: MockerFixture) -> None:
    ...
    database = mocker.MagicMock()
    warnings = mocker.patch("rama.db_engine_specs.base.warnings")
