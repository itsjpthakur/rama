...
def test_convert_dttm(
    ...
    from rama.db_engine_specs.clickhouse import (
...
def test_execute_connection_error() -> None:
    from rama.db_engine_specs.clickhouse import ClickHouseEngineSpec
    ...
    with pytest.raises(RamaDBAPIDatabaseError) as excinfo:
