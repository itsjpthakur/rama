...
from rama.db_engine_specs.doris import (
    AggState,
    ARRAY,
    BITMAP,
    DOUBLE,
...
def test_get_column_spec(
    ...
    from rama.db_engine_specs.doris import DorisEngineSpec as spec  # noqa: N813
...
def test_adjust_engine_params(
    ...
    from rama.db_engine_specs.doris import DorisEngineSpec
