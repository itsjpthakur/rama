...
def test_odbc_impersonation() -> None:
    ...
    from rama.db_engine_specs.drill import DrillEngineSpec
...
def test_invalid_impersonation() -> None:
    ...
    from rama.db_engine_specs.drill import DrillEngineSpec
    from rama.db_engine_specs.exceptions import RamaDBAPIProgrammingError

    url = URL.create("drill+foobar")
    username = "DoAsUser"

    with pytest.raises(RamaDBAPIProgrammingError):
...
def test_convert_dttm(
    ...
    from rama.db_engine_specs.drill import DrillEngineSpec as spec  # noqa: N813
