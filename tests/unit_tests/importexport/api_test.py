...
def test_export_assets(
    ...
    ExportAssetsCommand = mocker.patch("rama.importexport.api.ExportAssetsCommand")  # noqa: N806
...
def test_import_assets(
    ...
    ImportAssetsCommand = mocker.patch("rama.importexport.api.ImportAssetsCommand")  # noqa: N806
                    ...
                    "issue_codes": [
                        {
                            "code": 1010,
                            "message": (
                                "Issue 1010 - Rama encountered an error while "
                                "running a command."
                            ),
                        }
                    ]
