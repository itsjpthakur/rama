...
from rama.result_set import stringify_values, RamaResultSet
...
def test_column_names_as_bytes() -> None:
    ...
    result_set = RamaResultSet(data, description, RedshiftEngineSpec)  # type: ignore
...
def test_timezone_series(mocker: MockerFixture) -> None:
    ...
    """
    logger = mocker.patch("rama.result_set.logger")
