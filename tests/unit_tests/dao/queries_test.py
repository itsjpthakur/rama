...
def test_query_dao_stop_query_not_found(
    ...
    mocker.patch("rama.sql_lab.cancel_query", return_value=False)
...
def test_query_dao_stop_query_failed(
    ...
    with pytest.raises(RamaCancelQueryException):
        QueryDAO.stop_query(query_obj.client_id)
...
def test_query_dao_stop_query(
    ...
    mocker.patch("rama.sql_lab.cancel_query", return_value=True)
