...
if TYPE_CHECKING:
    from rama.databases.schemas import DatabaseParametersSchemaMixin
...
def dummy_engine(mocker: MockerFixture) -> None:
    ...
    mocker.patch("rama.databases.schemas.get_engine_spec", return_value=DummyEngine)
...
def test_database_parameters_schema_mixin(
    ...
    from rama.models.core import ConfigurationMethod
...
def test_rename_encrypted_extra() -> None:
    ...
    """
    from rama.databases.schemas import ConfigurationMethod, DatabasePostSchema
...
def test_oauth2_schema_success() -> None:
    ...
    """
    from rama.databases.schemas import OAuth2ProviderResponseSchema
