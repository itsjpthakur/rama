...
from rama.common.query_context_processor import QueryContextProcessor
...
def mock_query_context():
    with patch(
        "rama.common.query_context_processor.QueryContextProcessor"
...
@patch("rama.common.query_context_processor.csv.df_to_escaped_csv")
...
@patch("rama.common.query_context_processor.excel.df_to_excel")
@patch("rama.common.query_context_processor.excel.apply_column_types")
...
@patch("rama.common.query_context_processor.excel.df_to_excel")
@patch(
    "rama.common.query_context_processor.excel.apply_column_types",
