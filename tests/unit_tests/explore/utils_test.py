...
from rama.commands.exceptions import (
    DatasourceNotFoundValidationError,
    QueryNotFoundValidationError,
)
from rama.exceptions import RamaSecurityException
from rama.utils.core import DatasourceType, override_user

dataset_find_by_id = "rama.daos.dataset.DatasetDAO.find_by_id"
query_find_by_id = "rama.daos.query.QueryDAO.find_by_id"
chart_find_by_id = "rama.daos.chart.ChartDAO.find_by_id"
is_admin = "rama.security.RamaSecurityManager.is_admin"
is_owner = "rama.security.RamaSecurityManager.is_owner"
can_access_datasource = (
    "rama.security.RamaSecurityManager.can_access_datasource"
)
can_access = "rama.security.RamaSecurityManager.can_access"
raise_for_access = "rama.security.RamaSecurityManager.raise_for_access"
query_datasources_by_name = (
    "rama.connectors.sqla.models.SqlaTable.query_datasources_by_name"
)
...
def test_dataset_has_access(mocker: MockerFixture) -> None:
    from rama.connectors.sqla.models import SqlaTable
    from rama.explore.utils import check_datasource_access
...
def test_query_no_access(mocker: MockerFixture, client) -> None:
    ...
    with raises(RamaSecurityException):
