...
# Contributing to the Rama Embedded SDK

The rama-embedded-sdk directory is a self contained sub-project in the Rama codebase.

This is because the SDK has different requirements from other parts of the Rama codebase:
...
what happens if rama is offline
what happens if the rama domain is invalid or incorrect
