...
import { D3_FORMAT_OPTIONS, sharedControls } from '@rama-ui/chart-controls';
...
const sandboxUrl =
  ...
  'blob/master/rama-frontend/plugins/legacy-preset-chart-deckgl/src/utils/sandbox.ts';
const jsFunctionInfo = (
  <div>
    {t(
      'For more information about objects are in context in the scope of this function, refer to the',
    )}
    <a href={sandboxUrl}>{t(" source code of Rama's sandboxed parser")}.</a>
    .
  </div>
);
