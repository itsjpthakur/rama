...
export default styled(Chord)`
  ${({ theme }) => `
    .rama-legacy-chart-chord svg #circle circle {
      fill: none;
      pointer-events: all;
    }
    .rama-legacy-chart-chord svg .group path {
      fill-opacity: ${theme.opacity.mediumHeavy};
    }
    .rama-legacy-chart-chord svg path.chord {
      stroke: ${theme.colors.grayscale.dark2};
      stroke-width: 0.25px;
    }
    .rama-legacy-chart-chord svg #circle:hover path.fade {
