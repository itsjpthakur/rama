...
import { makeApi, t, logging } from '@rama-ui/core';
...
//   throw new Error(
//     `[rama] iframe parent ${parentOrigin} is not in the list of allowed origins`,
//   );
// }
 ...
 * 401 errors from the api and RamaClient will call this function.
 */
...
/**
 * Configures RamaClient with the correct settings for the embedded dashboard page.
 */
