...
export const DesignSystem = () => (
  ...
  While the Rama Design System will use Atomic Design principles, we choose a different language to describe the elements.

  | Atomic Design   |    Atoms    | Molecules  | Organisms | Templates | Pages / Screens |
  | :-------------- | :---------: | :--------: | :-------: | :-------: | :-------------: |
  | Rama Design | Foundations | Components | Patterns  | Templates |    Features     |
