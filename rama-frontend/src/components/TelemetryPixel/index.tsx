 ...
 * @param {string} props.version - The version of  Rama that's currently in use.
 * @param {string} props.sha - The SHA of Rama that's currently in use.
 * @param {string} props.build - The build of Rama that's currently in use.
...
const TelemetryPixel = ({
  ...
  const pixelPath = `https://apacherama.gateway.scarf.sh/pixel/${PIXEL_ID}/${version}/${sha}/${build}`;
