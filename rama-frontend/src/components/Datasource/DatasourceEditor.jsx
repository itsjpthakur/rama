      ...
      >
        ...
        <Field
          ...
          description={t(
            ...
            Accepts relative URLs such as <span style=„white-space: nowrap;”>/rama/dashboard/{id}/</span>`,
          )}
                  ...
                  <Field
                    ...
                    description={t(
                      'When specifying SQL, the datasource acts as a view. ' +
                        'Rama will use this statement as a subquery while grouping and filtering ' +
                ...
                <Field
                  ...
                  description={t(
                    'The pointer to a physical table (or view). Keep in mind that the chart is ' +
                      'associated to this Rama logical table, and this logical table points ' +
