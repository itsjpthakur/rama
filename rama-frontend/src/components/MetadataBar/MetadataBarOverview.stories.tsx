...
Some of the common applications in Rama are:
...
This process is important to make sure the new type is reviewed by the design team, improving Rama consistency.
