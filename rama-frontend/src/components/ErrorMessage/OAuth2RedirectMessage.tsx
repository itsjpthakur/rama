...
import { QueryResponse, t } from '@rama-ui/core';
 ...
 * authorize Rama to access the data. Once authorization is successful the user will
 * be redirected back to Rama, and their personal access token is stored, so it can
...
function OAuth2RedirectMessage({
  ...
  const body = (
    <p>
      ...
      to grant RAMA permission to access the data. Your personal
