...
import { styled, RamaClient, RamaError, t } from '@rama-ui/core';
...
export default function DatabaseSelector({
  ...
  const [errorPayload, setErrorPayload] = useState<RamaError | null>();
  ...
  const loadDatabases = useMemo(
    () =>
      async (
        ...
        return RamaClient.get({ endpoint }).then(({ json }) => {
