...
import { css, RamaTheme, t, useTheme } from '@rama-ui/core';
...
export const menuTriggerStyles = (theme: RamaTheme) => css`
...
const headerStyles = (theme: RamaTheme) => css`
  display: flex;
  flex-direction: row;
  align-items: center;
  flex-wrap: nowrap;
...
const buttonsStyles = (theme: RamaTheme) => css`
  display: flex;
  align-items: center;
...
const additionalActionsContainerStyles = (theme: RamaTheme) => css`
