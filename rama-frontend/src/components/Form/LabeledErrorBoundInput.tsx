...
import { styled, css, RamaTheme, t } from '@rama-ui/core';
...
const alertIconStyles = (theme: RamaTheme, hasError: boolean) => css`
...
const LabeledErrorBoundInput = ({
  ...
  <StyledFormGroup className={className}>
    ...
    <FormItem
      css={(theme: RamaTheme) => alertIconStyles(theme, !!errorMessage)}
