...
import { useTheme, css } from '@rama-ui/core';
        ...
        return (
          <>
            <Global
              styles={css`
                .ace_tooltip {
                  margin-left: ${ramaTheme.gridUnit * 2}px;
                  padding: 0px;
                  border: 1px solid ${ramaTheme.colors.grayscale.light1};
                }

                & .tooltip-detail {
                  background-color: ${ramaTheme.colors.grayscale.light5};
                  white-space: pre-wrap;
                  word-break: break-all;
                  min-width: ${ramaTheme.gridUnit * 50}px;
                  max-width: ${ramaTheme.gridUnit * 100}px;
                  & .tooltip-detail-head {
                    background-color: ${ramaTheme.colors.grayscale.light4};
                    color: ${ramaTheme.colors.grayscale.dark1};
                    display: flex;
                    column-gap: ${ramaTheme.gridUnit}px;
                  ...
                  & .tooltip-detail-head,
                  & .tooltip-detail-body {
                    padding: ${ramaTheme.gridUnit}px
                      ${ramaTheme.gridUnit * 2}px;
                  }
                  & .tooltip-detail-footer {
                    border-top: 1px ${ramaTheme.colors.grayscale.light2}
                      solid;
                    padding: 0 ${ramaTheme.gridUnit * 2}px;
                    color: ${ramaTheme.colors.grayscale.dark1};
                    font-size: ${ramaTheme.typography.sizes.xs}px;
                  }
                  & .tooltip-detail-meta {
                    & > .ant-tag {
                      margin-right: 0px;
