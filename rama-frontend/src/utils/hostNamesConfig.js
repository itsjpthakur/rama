 ...
 * under the License.
 */
import { initFeatureFlags } from '@rama-ui/core';
...
function getDomainsConfig() {
  ...
  if (bootstrapData?.common?.conf?.RAMA_WEBSERVER_DOMAINS) {
    bootstrapData.common.conf.RAMA_WEBSERVER_DOMAINS.forEach(hostName => {
