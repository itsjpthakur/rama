...
export type { JsonResponse, TextResponse } from '@rama-ui/core';

export const ramaClientQuery: BaseQueryFn<
  Pick<RequestBase, 'method' | 'body' | 'jsonPayload' | 'postPayload'> & {
    endpoint: string;
    parseMethod?: ParseMethod;
    transformResponse?: (response: RamaClientResponse) => JsonValue;
