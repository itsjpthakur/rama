...
export const getDatabaseImages = () => RamaText.DB_IMAGES;

export const getConnectionAlert = () => RamaText.DB_CONNECTION_ALERTS;
export const getDatabaseDocumentationLinks = () =>
  RamaText.DB_CONNECTION_DOC_LINKS;
