...
import RamaText from 'src/utils/textUtils';
...
const createFetchResourceMethod =
  ...
  async (filterValue = '', page: number, pageSize: number) => {
    ...
    const { json = {} } = await RamaClient.get({
...
export const getRecentActivityObjs = (
  ...
  RamaClient.get({ endpoint: recent }).then(recentsRes => {
    const res: any = {};
...
export const StyledIcon = (theme: RamaTheme) => css`
