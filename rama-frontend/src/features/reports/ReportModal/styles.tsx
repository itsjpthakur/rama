...
import { styled, css, RamaTheme } from '@rama-ui/core';
...
export const TimezoneHeaderStyle = (theme: RamaTheme) => css`
  margin: ${theme.gridUnit * 3}px 0 ${theme.gridUnit * 2}px;
`;

export const CustomWidthHeaderStyle = (theme: RamaTheme) => css`
  margin: ${theme.gridUnit * 3}px 0 ${theme.gridUnit * 2}px;
`;

export const SectionHeaderStyle = (theme: RamaTheme) => css`
