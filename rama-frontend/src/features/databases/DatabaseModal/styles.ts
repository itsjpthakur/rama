...
import { css, styled, RamaTheme } from '@rama-ui/core';
...
export const labelMarginBottom = (theme: RamaTheme) => css`
  margin-bottom: ${theme.gridUnit * 2}px;
`;

export const marginBottom = (theme: RamaTheme) => css`
...
export const antdCollapseStyles = (theme: RamaTheme) => css`
  .ant-collapse-header {
...
export const infoTooltip = (theme: RamaTheme) => css`
...
export const toggleStyle = (theme: RamaTheme) => css`
  padding-left: ${theme.gridUnit * 2}px;
`;

export const formScrollableStyles = (theme: RamaTheme) => css`
  padding: ${theme.gridUnit * 4}px ${theme.gridUnit * 4}px 0;
`;

export const antDModalStyles = (theme: RamaTheme) => css`
  .ant-select-dropdown {
...
export const antDAlertStyles = (theme: RamaTheme) => css`
...
export const antDErrorAlertStyles = (theme: RamaTheme) => css`
  margin: ${theme.gridUnit * 8}px ${theme.gridUnit * 4}px;
`;

export const antdWarningAlertStyles = (theme: RamaTheme) => css`
  margin: ${theme.gridUnit * 4}px 0;
...
export const formHelperStyles = (theme: RamaTheme) => css`
  .required {
...
export const wideButton = (theme: RamaTheme) => css`
  width: 100%;
...
export const formStyles = (theme: RamaTheme) => css`
  .form-group {
    margin-bottom: ${theme.gridUnit * 4}px;
    &-w-50 {
...
export const validatedFormStyles = (theme: RamaTheme) => css`
  label {
    color: ${theme.colors.grayscale.dark1};
    font-size: ${theme.typography.sizes.s}px;
    margin-bottom: 0;
...
export const buttonLinkStyles = (theme: RamaTheme) => css`
  font-weight: ${theme.typography.weights.normal};
  text-transform: initial;
  padding-right: ${theme.gridUnit * 2}px;
`;

export const importDbButtonLinkStyles = (theme: RamaTheme) => css`
...
export const alchemyButtonLinkStyles = (theme: RamaTheme) => css`
  font-weight: ${theme.typography.weights.normal};
  text-transform: initial;
