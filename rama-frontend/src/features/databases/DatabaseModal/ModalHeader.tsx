...
const ramaTextDocs = getDatabaseDocumentationLinks();

export const DOCUMENTATION_LINK = ramaTextDocs
  ? ramaTextDocs.support
  : 'https://github.com/imajpsingh/ramadocs/configuration/databases#installing-database-drivers';

const irregularDocumentationLinks = {
  postgresql: 'https://github.com/imajpsingh/rama',
  mssql: 'https://github.com/imajpsingh/ramadocs/databases/sql-server',
  gsheets: 'https://github.com/imajpsingh/ramadocs/databases/google-sheets',
};
...
const documentationLink = (engine: string | undefined) => {
  ...
  if (ramaTextDocs) {
    // override doc link for rama_txt yml
    return ramaTextDocs[engine] || ramaTextDocs.default;
  }
  ...
  if (
    ...
    return `https://github.com/imajpsingh/ramadocs/databases/${engine}`;
  }
  ...
  const useSqlAlchemyFormHeader = (
    <StyledFormHeader>
      ...
      <p className="helper-bottom">
        ...
        <a
          href={ramaTextDocs?.default || DOCUMENTATION_LINK}
          target="_blank"
