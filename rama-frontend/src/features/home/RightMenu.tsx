...
const versionInfoStyles = (theme: RamaTheme) => css`
...
const styledDisabled = (theme: RamaTheme) => css`
...
const tagStyles = (theme: RamaTheme) => css`
  color: ${theme.colors.grayscale.light5};
`;

const styledChildMenu = (theme: RamaTheme) => css`
  &:hover {
...
const RightMenu = ({
  ...
  const canSql = findPermission('can_sqllab', 'Rama', roles);
...
// Rama still has multiple entry points, and not all of them have
