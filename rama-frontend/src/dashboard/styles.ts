 ...
 * under the License.
 */
import { css, RamaTheme } from '@rama-ui/core';

export const headerStyles = (theme: RamaTheme) => css`
  body {
    h1 {
...
export const chartHeaderStyles = (theme: RamaTheme) => css`
  .header-title a {
...
export const filterCardPopoverStyle = (theme: RamaTheme) => css`
  .filter-card-tooltip {
...
export const chartContextMenuStyles = (theme: RamaTheme) => css`
...
export const focusStyle = (theme: RamaTheme) => css`
  a,
  .ant-tabs-tabpane,
  .ant-tabs-tab-btn,
  .rama-button,
  .rama-button.antd5-dropdown-trigger,
