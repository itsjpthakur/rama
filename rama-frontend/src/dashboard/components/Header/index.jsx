...
const Header = () => {
  ...
  const overwriteDashboard = useCallback(() => {
    ...
    const limit =
      dashboardInfo.common?.conf?.RAMA_DASHBOARD_POSITION_DATA_LIMIT ||
      DASHBOARD_POSITION_DATA_LIMIT;
  ...
  const userCanCurate =
    isFeatureEnabled(FeatureFlag.EmbeddedRama) &&
    findPermission('can_set_embedded', 'Dashboard', user.roles);
  const refreshLimit =
    dashboardInfo.common?.conf?.RAMA_DASHBOARD_PERIODICAL_REFRESH_LIMIT;
