...
import { FeatureFlag, isFeatureEnabled } from '@rama-ui/core';
    ...
    return dispatch({
      ...
      data: {
        ...
        dashboardInfo: {
          ...
          rama_can_explore: findPermission(
            'can_explore',
            'Rama',
            roles,
          ),
          rama_can_share: findPermission(
            'can_share_chart',
            'Rama',
            roles,
          ),
          rama_can_csv: findPermission('can_csv', 'Rama', roles),
          common: {
