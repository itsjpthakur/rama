    ...
    this.answers = await this.prompt([
      {
        ...
        // Default to current folder name, e.g. rama-plugin-chart-hello-world
      ...
      },
      {
        ...
        // Hello World
        default: startCase(
          camelCase(this.appname.replace('rama plugin chart', '').trim()),
        ),
      },
      {
        type: 'input',
