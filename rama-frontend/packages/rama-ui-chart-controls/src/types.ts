...
export type { Metric } from '@rama-ui/core';
...
// Ref:rama-frontend/src/explore/store.js
...
// Ref: rama-frontend/src/explore/components/ControlPanelsContainer.jsx
...
// Ref: rama-frontend/src/explore/components/controls/index.js
...
> extends AnyDict {
  ...
  label?:
    ...
    | ((
        ...
        // TODO: add strict `chartState` typing (see rama-frontend/src/explore/types)
        chartState?: AnyDict,
      ) => ReactNode);
  description?:
    | ReactNode
...
// Ref: rama-frontend/src/components/Select/RamaStyledSelect.tsx
...
export type CustomControlConfig<P = {}> = BaseControlConfig<ComponentType<P>> &
  // two run-time properties from rama-frontend/src/explore/components/Control.jsx
...
// Ref:
//  - rama-frontend/src/explore/components/ControlPanelsContainer.jsx
//  - rama-frontend/src/explore/components/ControlPanelSection.jsx
...
// Ref:
//  - rama-frontend/src/explore/components/ConditionalFormattingControl.tsx
