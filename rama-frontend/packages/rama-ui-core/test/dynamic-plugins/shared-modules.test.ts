...
describe('shared modules', () => {
  ...
  it('assigns to window', async () => {
    ...
    expect((window as any)['__rama__/test-module']).toStrictEqual(
      fakeModule,
    );
  });
  ...
  it('shares a map of modules', async () => {
    ...
    expect((window as any)['__rama__/module-foo']).toEqual(foo);
    expect((window as any)['__rama__/module-fizz']).toEqual(fizz);
  });
});
