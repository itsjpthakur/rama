...
// the RamaClientResponse object, and can contain a spread JSON blob
...
export function getClientErrorObject(
  ...
  // takes a RamaClientResponse as input, attempts to read response as Json
