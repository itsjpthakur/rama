...
export interface RamaClientInterface
  extends Pick<
    RamaClientClass,
    | 'delete'
    | 'get'
    ...
    | 'getGuestToken'
  > {
  configure: (config?: ClientConfig) => RamaClientInterface;
  reset: () => void;
}

export type RamaClientResponse = Response | JsonResponse | TextResponse;
