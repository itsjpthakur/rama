...
export default class RamaClientClass {
  ...
  isAuthenticated(): boolean {
    // if CSRF protection is disabled in the Rama app, the token may be an empty string
  ...
  async ensureAuth(): CsrfPromise {
    return (
      ...
      Promise.reject({
        error: `RamaClient has not been provided a CSRF token, ensure it is
