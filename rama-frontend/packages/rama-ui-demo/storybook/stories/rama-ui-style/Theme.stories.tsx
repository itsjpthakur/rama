...
import { ramaTheme } from '@rama-ui/core';

export default {
  title: 'Core Packages/@rama-ui-style',
};

export const ThemeColors = () => {
  const { colors } = ramaTheme;
  ...
  return (
    <div>
      ...
      <h3>The ramaTheme object</h3>
      <code>
        <pre>{JSON.stringify(ramaTheme, null, 2)}</pre>
      </code>
    </div>
  );
};
