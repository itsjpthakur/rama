...
export const renderError = (error: Error) => (
  <div>
    ...
    1) configured CORS in Rama to receive requests from this domain. <br />
    2) set the Rama host correctly below. <br />
    3) debug the CORS configuration under the `@rama-ui/connection` stories.
    <br />
    <br />
    ...
    return didVerify ? (
      ...
      <div className="row">
        <div className="col-md-10">
          ...
          <br />
          1) enable CORS requests in your Rama App from{' '}
          {`${window.location.origin}`}
          <br />
          2) configure your Rama App host name below <br />
          3) click below to verify authentication. You may debug CORS further
          using the `@rama-ui/connection` story. <br />
          <br />
          <button
            type="button"
