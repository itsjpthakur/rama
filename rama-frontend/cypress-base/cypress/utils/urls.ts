...
export const WORLD_HEALTH_DASHBOARD = '/rama/dashboard/world_health/';
export const SAMPLE_DASHBOARD_1 = '/rama/dashboard/1-sample-dashboard/';
export const SUPPORTED_CHARTS_DASHBOARD =
  '/rama/dashboard/supported_charts_dash/';
export const TABBED_DASHBOARD = '/rama/dashboard/tabbed_dash/';
