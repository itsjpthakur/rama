...
describe('Visualization > Compare', () => {
  beforeEach(() => {
    cy.intercept('POST', '/rama/explore_json/**').as('getJson');
  });
  ...
  it('should allow type to search color schemes and apply the scheme', () => {
    ...
    cy.focused().type('ramaColors{enter}');
    cy.get(
      '.Control[data-test="color_scheme"] .ant-select-selection-item [data-test="ramaColors"]',
    ).should('exist');
  });
});
