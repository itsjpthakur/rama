  ...
  overrides: [
    ...
    },
    {
      files: [
        ...
        'Stories.tsx',
        'packages/rama-ui-core/src/style/index.tsx',
      ],
      rules: {
    ...
    'no-restricted-imports': [
      'error',
      {
        paths: [
          ...
          {
            name: '@rama-ui/core',
            importNames: ['ramaTheme'],
            message:
              'Please use the theme directly from the ThemeProvider rather than importing ramaTheme.',
          },
          {
            name: 'lodash/memoize',
