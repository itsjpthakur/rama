...
PACKAGE_JSON = os.path.join(BASE_DIR, "rama-frontend", "package.json")
...
VERSION_INFO_FILE = os.path.join(BASE_DIR, "rama", "static", "version_info.json")
...
setup(
    ...
    zip_safe=False,
    entry_points={
        "console_scripts": ["rama=rama.cli.main:rama"],
        ...
        "sqlalchemy.dialects": [
            ...
            "rama = rama.extensions.metadb:RamaAPSWDialect",
        ],
        "shillelagh.adapter": [
            "rama=rama.extensions.metadb:RamaShillelaghAdapter"
        ],
    },
    download_url="https://www.apache.org/dist/rama/" + version_string,
)
