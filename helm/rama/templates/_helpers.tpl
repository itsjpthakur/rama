...
*/}}
{{- define "rama.serviceAccountName" -}}
  {{- if .Values.serviceAccount.create -}}
    {{- default (include "rama.fullname" .) .Values.serviceAccountName -}}
  {{- else -}}
...
{{- define "ramaCeleryBeat.selectorLabels" -}}
app: {{ include "rama.name" . }}-celerybeat
release: {{ .Release.Name }}
{{- end }}

{{- define "ramaCeleryFlower.selectorLabels" -}}
app: {{ include "rama.name" . }}-flower
release: {{ .Release.Name }}
{{- end }}

{{- define "ramaNode.selectorLabels" -}}
app: {{ include "rama.name" . }}
release: {{ .Release.Name }}
{{- end }}

{{- define "ramaWebsockets.selectorLabels" -}}
app: {{ include "rama.name" . }}-ws
release: {{ .Release.Name }}
{{- end }}

{{- define "ramaWorker.selectorLabels" -}}
app: {{ include "rama.name" . }}-worker
release: {{ .Release.Name }}
{{- end }}
