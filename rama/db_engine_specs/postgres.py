...
from rama.db_engine_specs.base import BaseEngineSpec, BasicParametersMixin
from rama.errors import ErrorLevel, RamaError, RamaErrorType
from rama.exceptions import RamaException, RamaSecurityException
...
class PostgresBaseEngineSpec(BaseEngineSpec):
    ...
    custom_errors: dict[Pattern[str], tuple[str, RamaErrorType, dict[str, Any]]] = {
        ...
        CONNECTION_INVALID_PASSWORD_NEEDED_REGEX: (
            ...
            RamaErrorType.CONNECTION_ACCESS_DENIED_ERROR,
            {"invalid": ["password"]},
        ),
        ...
        CONNECTION_PORT_CLOSED_REGEX: (
            ...
            RamaErrorType.CONNECTION_PORT_CLOSED_ERROR,
            {"invalid": ["host", "port"]},
        ),
        CONNECTION_HOST_DOWN_REGEX: (
            ...
            RamaErrorType.CONNECTION_HOST_DOWN_ERROR,
            {"invalid": ["host", "port"]},
        ),
...
class PostgresEngineSpec(BasicParametersMixin, PostgresBaseEngineSpec):
    ...
    def get_schema_from_engine_params(
        ...
        in Rama because it breaks schema-level permissions, since it's impossible
        ...
        if search_path := options.get("search_path"):
            ...
            if len(schemas) > 1:
                raise Exception(  # pylint: disable=broad-exception-raised
                    ...
                    "Rama is unable to determine the schema of unqualified table "
...
WHERE datistemplate = false;
    ...
    def get_extra_params(database: Database) -> dict[str, Any]:
        ...
        :raises RamaException: If database extra json payload is unparseable
        """
        try:
            extra = json.loads(database.extra or "{}")
        except json.JSONDecodeError as ex:
            raise RamaException("Unable to parse database extras") from ex
