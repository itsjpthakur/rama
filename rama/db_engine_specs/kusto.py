...
class KustoSqlEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            kusto_exceptions.DatabaseError: RamaDBAPIDatabaseError,
            kusto_exceptions.OperationalError: RamaDBAPIOperationalError,
            kusto_exceptions.ProgrammingError: RamaDBAPIProgrammingError,
        }
