...
from rama import cache_manager, db, is_feature_enabled
...
from rama.models.sql_types.presto_sql_types import (
    Array,
    Date,
    Interval,
    Map,
...
from rama.result_set import destringify
...
class PrestoBaseEngineSpec(BaseEngineSpec, metaclass=ABCMeta):
    ...
    def convert_dttm(
        ...
        Rama only defines time zone naive `datetime` objects, though this method
        ...
        **kwargs: Any,
        ...
        for k in kwargs.keys():  # pylint: disable=consider-iterating-dictionary
            if k not in k in part_fields:  # pylint: disable=comparison-with-itself
                ...
                raise RamaTemplateException(msg)
