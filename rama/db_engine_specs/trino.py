...
from rama.db_engine_specs.base import BaseEngineSpec, convert_inspector_columns
...
from rama.db_engine_specs.presto import PrestoBaseEngineSpec
...
class TrinoEngineSpec(PrestoBaseEngineSpec):
    ...
    def cancel_query(cls, cursor: Cursor, query: Query, cancel_query_id: str) -> bool:
        ...
        try:
            cursor.execute(
                ...
                "message => 'Query cancelled by Rama')"
            )
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        static_mapping: dict[type[Exception], type[Exception]] = {
            requests_exceptions.ConnectionError: RamaDBAPIConnectionError,
        }
