...
class ElasticSearchEngineSpec(BaseEngineSpec):  # pylint: disable=abstract-method
    ...
    def get_dbapi_exception_mapping(cls) -> dict[type[Exception], type[Exception]]:
        ...
        return {
            es_exceptions.DatabaseError: RamaDBAPIDatabaseError,
            es_exceptions.OperationalError: RamaDBAPIOperationalError,
            es_exceptions.ProgrammingError: RamaDBAPIProgrammingError,
        }
