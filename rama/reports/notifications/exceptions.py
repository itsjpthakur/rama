...
class NotificationError(RamaException):
    """
...
class SlackV1NotificationError(RamaException):
    """
...
class NotificationParamException(RamaException):
    status = 422


class NotificationAuthorizationException(RamaException):
    status = 401


class NotificationUnprocessableException(RamaException):
    """
...
class NotificationMalformedException(RamaException):
    status = 400
