...
from rama import conf
from rama.available_domains.schemas import AvailableDomainsSchema
...
class AvailableDomainsRestApi(BaseRamaApi):
    ...
    def get(self) -> Response:
        """
        Get the list of available Rama Webserver domains (if any)
        ...
        result = self.available_domains_schema.dump(
            {"domains": conf.get("RAMA_WEBSERVER_DOMAINS")}
        )
