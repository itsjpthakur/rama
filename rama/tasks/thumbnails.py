...
from rama import security_manager, thumbnail_cache
from rama.extensions import celery_app
from rama.security.guest_token import GuestToken
...
from rama.utils.webdriver import WindowSize
...
def cache_dashboard_thumbnail(
    ...
    url = get_url_path("Rama.dashboard", dashboard_id_or_slug=dashboard.id)
