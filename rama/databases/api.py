...
from rama import app, event_logger
from rama.commands.database.create import CreateDatabaseCommand
from rama.commands.database.delete import DeleteDatabaseCommand
...
from rama.commands.database.importers.dispatcher import ImportDatabasesCommand
...
from rama.commands.database.uploaders.base import (
    BaseDataReader,
    UploadCommand,
    UploadFileType,
)
from rama.commands.database.uploaders.columnar_reader import ColumnarReader
from rama.commands.database.uploaders.csv_reader import CSVReader
from rama.commands.database.uploaders.excel_reader import ExcelReader
from rama.commands.database.validate import ValidateDatabaseParametersCommand
from rama.commands.database.validate_sql import ValidateSQLCommand
from rama.commands.importers.exceptions import (
...
from rama.daos.database import DatabaseDAO, DatabaseUserOAuth2TokensDAO
from rama.databases.decorators import check_table_access
from rama.databases.filters import DatabaseFilter, DatabaseUploadEnabledFilter
from rama.databases.schemas import (
...
from rama.databases.utils import get_table_metadata
from rama.db_engine_specs import get_available_engine_specs
...
from rama.utils.core import error_msg_from_exception, parse_js_uri_path_item
from rama.utils.decorators import transaction
from rama.utils.oauth2 import decode_oauth2_state
from rama.utils.ssh_tunnel import mask_password_info
...
from rama.views.error_handling import handle_api_exception, json_error_response
from rama.views.filters import BaseFilterRelatedUsers, FilterRelatedOwners

logger = logging.getLogger(__name__)


# pylint: disable=too-many-public-methods
class DatabaseRestApi(BaseRamaModelRestApi):
    ...
    def oauth2(self) -> FlaskResponse:
        ...
        return make_response(
            render_template("rama/oauth2.html", tab_id=state["tab_id"]),
            200,
        )
