...
from rama import app, appbuilder, cli, security_manager
from rama.cli.lib import normalize_token
...
def version(verbose: bool) -> None:
    ...
    print(Fore.BLUE + "-=" * 15)
    print(Fore.YELLOW + "Rama " + Fore.CYAN + f"{app.config['VERSION_STRING']}")
    print(Fore.BLUE + "-=" * 15)
    if verbose:
