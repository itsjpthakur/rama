...
import rama.utils.database as database_utils
from rama.utils.decorators import transaction
from rama.utils.encrypt import SecretsMigrator
...
def sync_tags() -> None:
    ...
    from rama.common.tags import add_favorites, add_owners, add_types
...
def update_api_docs() -> None:
    ...
    rama_dir = os.path.abspath(os.path.dirname(__file__))
    openapi_json = os.path.join(
        rama_dir, "..", "..", "docs", "static", "resources", "openapi.json"
    )
    api_version = "v1"
