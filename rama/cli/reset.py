...
from rama.cli.lib import feature_flags
...
if feature_flags.get("ENABLE_FACTORY_RESET_COMMAND"):
    ...
    @click.option(
        ...
        is_flag=True,
        prompt=(
            "Are you sure you want to reset Rama? "
    ...
    def factory_reset(
        ...
        from rama.commands.security.reset import ResetRamaCommand
        ...
        try:
            ResetRamaCommand(silent, user, exclude_users, exclude_roles).run()
