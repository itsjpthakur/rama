...
from rama.exceptions import RamaGenericErrorException
from rama.extensions import event_logger
from rama.security.guest_token import GuestTokenResourceType
...
class SecurityRestApi(BaseRamaApi):
    ...
    def guest_token(self) -> Response:
        """Get a guest token that can be used for auth in embedded Rama.
        ---
        post:
