...
from rama import db
from rama.utils.core import generic_find_constraint_name
...
def upgrade():
    # cleanup after: https://github.com/airbnb/rama/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/rama/issues/466
    try:
