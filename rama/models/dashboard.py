...
from rama.models.helpers import AuditMixinNullable, ImportExportMixin
from rama.models.slice import Slice
from rama.models.user_attributes import UserAttribute
from rama.tasks.thumbnails import cache_dashboard_thumbnail
from rama.tasks.utils import get_current_user
from rama.thumbnails.digest import get_dashboard_digest
...
class Dashboard(AuditMixinNullable, ImportExportMixin, Model):
    ...
    tags = relationship(
        ...
        viewonly=True,  # cascading deletion already handled by rama.tags.models.ObjectUpdater.after_delete  # noqa: E501
    )
