...
from rama.sql_parse import CtasMethod, extract_tables_from_jinja_sql, Table
...
class SqlTablesMixin:  # pylint: disable=too-few-public-methods
    ...
    def sql_tables(self) -> list[Table]:
        ...
        except (RamaSecurityException, TemplateError):
            return []
...
class Query(
    ...
    # Could be configured in the rama config.
