...
from rama.thumbnails.digest import get_chart_digest
from rama.utils import core as utils, json
from rama.viz import BaseViz, viz_types

if TYPE_CHECKING:
    from rama.common.query_context import QueryContext
    from rama.common.query_context_factory import QueryContextFactory
...
class Slice(  # pylint: disable=too-many-public-methods
    ...
    def explore_json_url(self) -> str:
        """Defines the url to access the slice"""
        return self.get_explore_url("/rama/explore_json")
