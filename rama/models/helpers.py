...
from rama import app, db, is_feature_enabled
from rama.advanced_data_type.types import AdvancedDataTypeResponse
from rama.common.db_query_status import QueryStatus
from rama.common.utils.time_range_utils import get_since_until_from_time_range
from rama.constants import EMPTY_STRING, NULL_STRING
from rama.db_engine_specs.base import TimestampExpression
...
from rama.utils.dates import datetime_to_epoch

if TYPE_CHECKING:
    from rama.connectors.sqla.models import SqlMetric, TableColumn
...
def validate_adhoc_subquery(
    ...
    :raise RamaSecurityException if sql contains sub-queries or
        ...
        if has_table:
            if not is_feature_enabled("ALLOW_ADHOC_SUBQUERY"):
                raise RamaSecurityException(
                    RamaError(
                        error_type=RamaErrorType.ADHOC_SUBQUERY_NOT_ALLOWED_ERROR,
