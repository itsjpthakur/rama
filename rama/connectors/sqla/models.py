...
from rama.jinja_context import (
    BaseTemplateProcessor,
    ExtraCache,
    get_template_processor,
)
from rama.models.annotations import Annotation
from rama.models.core import Database
from rama.models.helpers import (
    AuditMixinNullable,
    CertificationMixin,
    ExploreMixin,
    ImportExportMixin,
...
class BaseDatasource(AuditMixinNullable, ImportExportMixin):  # pylint: disable=too-many-public-methods
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        query_obj is a dictionary representing Rama's query interface.
        Should return a ``rama.models.helpers.QueryResult``
        """
        raise NotImplementedError()
    ...
    def get_sqla_row_level_filters(
        ...
        try:
            ...
            if is_feature_enabled("EMBEDDED_RAMA"):
...
class SqlaTable(
        ...
        if col_in_metadata := self.get_column(expression):
            ...
            if has_timegrain or force_type_check:
                try:
                    ...
                    if not col_desc:
                        raise RamaGenericDBErrorException("Column not found")
                    is_dttm = col_desc[0]["is_dttm"]  # type: ignore
                except RamaGenericDBErrorException as ex:
    ...
    def query(self, query_obj: QueryObjectDict) -> QueryResult:
        ...
        except (RamaErrorException, RamaErrorsException):
            # RamaError(s) exception should not be captured; instead, they should
