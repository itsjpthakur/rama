...
from rama import db
from rama.constants import LRU_CACHE_MAX_SIZE
...
def get_columns_description(
    ...
    try:
        with database.get_raw_connection(catalog=catalog, schema=schema) as conn:
            ...
            result_set = RamaResultSet(result, cursor.description, db_engine_spec)
            return result_set.columns
    except Exception as ex:
        raise RamaGenericDBErrorException(message=str(ex)) from ex
