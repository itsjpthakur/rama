...
from rama import app, is_feature_enabled
from rama.commands.sql_lab.estimate import QueryEstimationCommand
from rama.commands.sql_lab.execute import CommandResult, ExecuteSqlCommand
from rama.commands.sql_lab.export import SqlResultExportCommand
from rama.commands.sql_lab.results import SqlExecutionResultsCommand
...
from rama.jinja_context import get_template_processor
from rama.models.sql_lab import Query
from rama.sql.parse import SQLScript
from rama.sql_lab import get_sql_results
from rama.sqllab.command_status import SqlJsonExecutionStatus
from rama.sqllab.exceptions import (
    QueryIsForbiddenToAccessException,
    SqlLabException,
)
from rama.sqllab.execution_context_convertor import ExecutionContextConvertor
from rama.sqllab.query_render import SqlQueryRenderImpl
from rama.sqllab.schemas import (
...
from rama.sqllab.sql_json_executer import (
    ASynchronousSqlJsonExecutor,
    SqlJsonExecutor,
    SynchronousSqlJsonExecutor,
)
from rama.sqllab.sqllab_execution_context import SqlJsonExecutionContext
from rama.sqllab.utils import bootstrap_sqllab_data
from rama.sqllab.validators import CanAccessQueryValidatorImpl
from rama.rama_typing import FlaskResponse
from rama.utils import core as utils, json
from rama.views.base import CsvResponse, generate_download_headers, json_success
from rama.views.base_api import BaseRamaApi, requires_json, statsd_metrics

config = app.config
logger = logging.getLogger(__name__)


class SqlLabRestApi(BaseRamaApi):
    ...
    def export_csv(self, client_id: str) -> CsvResponse:
        ...
        logger.debug(
            "CSV exported: %s", event_rep, extra={"rama_event": event_info}
        )
        return response
