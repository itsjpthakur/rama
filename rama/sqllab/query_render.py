...
from rama.commands.sql_lab.execute import SqlQueryRender
from rama.errors import RamaErrorType
from rama.sqllab.exceptions import SqlLabException
...
class SqlQueryRenderImpl(SqlQueryRender):
    ...
    def _raise_undefined_parameter_exception(
        ...
        raise SqlQueryRenderException(
            ...
            error_type=RamaErrorType.MISSING_TEMPLATE_PARAMS_ERROR,
    ...
    def _raise_template_exception(
        ...
        raise SqlQueryRenderException(
            sql_json_execution_context=execution_context,
            error_type=RamaErrorType.INVALID_TEMPLATE_PARAMS_ERROR,
            reason_message=__(
