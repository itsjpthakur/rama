...
if TYPE_CHECKING:
    ...
    from rama.sqllab.sql_json_executer import SqlJsonExecutor
...
class ExecuteSqlCommand(BaseCommand):
    ...
    def run(  # pylint: disable=too-many-statements,useless-suppression
        ...
        try:
            ...
            # RamaErrorsException || RamaErrorsException
            raise
    ...
    def _validate_query_db(cls, database: Database | None) -> None:
        if not database:
            raise RamaGenericErrorException(
                __(
