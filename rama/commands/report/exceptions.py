...
from rama.exceptions import RamaError, RamaErrorsException
...
class ReportScheduleSystemErrorsException(CommandException, RamaErrorsException):
    errors: list[RamaError] = []
    message = _("Report schedule system error")


class ReportScheduleClientErrorsException(CommandException, RamaErrorsException):
    status = 400
    errors: list[RamaError] = []
