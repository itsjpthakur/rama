...
from rama import app, db, security_manager
...
from rama.commands.exceptions import CommandException, UpdateFailedError
from rama.commands.report.alert import AlertCommand
...
from rama.exceptions import RamaErrorsException, RamaException
from rama.extensions import feature_flag_manager, machine_auth_provider_factory
...
from rama.reports.notifications import create_notification
...
from rama.tasks.utils import get_executor
from rama.utils import json
from rama.utils.core import HeaderDataType, override_user
from rama.utils.csv import get_chart_csv_data, get_chart_dataframe
from rama.utils.decorators import logs_context, transaction
from rama.utils.pdf import build_pdf_from_screenshots
from rama.utils.screenshots import ChartScreenshot, DashboardScreenshot
from rama.utils.slack import get_channels_with_search, SlackChannelTypes
...
class BaseReportState:
    ...
    def _send(
        ...
        """
        notification_errors: list[RamaError] = []
        for recipient in recipients:
            ...
            except (NotificationError, RamaException) as ex:
                # collect errors but keep processing them
                notification_errors.append(
                    RamaError(
                        message=ex.message,
                        error_type=RamaErrorType.REPORT_NOTIFICATION_ERROR,
                        level=(
...
class ReportNotTriggeredErrorState(BaseReportState):
    ...
    def next(self) -> None:
        ...
        try:
        ...
        except (RamaErrorsException, Exception) as first_ex:
            error_message = str(first_ex)
            if isinstance(first_ex, RamaErrorsException):
            ...
            if not self.is_in_error_grace_period():
                ...
                except RamaErrorsException as second_ex:
