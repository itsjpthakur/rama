...
from rama.models.core import Database, FavStar, Log
...
class ResetRamaCommand(BaseCommand):
    def __init__(
        self,
        confirm: bool,
        user: Any,
    ...
    def run(self) -> None:
        self.validate()
        logger.debug("Resetting Rama Started")
        ...
        logger.debug("Resetting Rama Completed")
