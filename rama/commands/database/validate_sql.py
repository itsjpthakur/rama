...
from rama.sql_validators import get_validator_by_name
from rama.sql_validators.base import BaseSQLValidator
    ...
    def run(self) -> list[dict[str, Any]]:
        ...
        try:
            ...
            if re.search(r"([\W]|^)4\d{2}([\W]|$)", str(ex)):
                raise ValidatorSQL400Error(rama_error) from ex
            raise ValidatorSQLError(rama_error) from ex
