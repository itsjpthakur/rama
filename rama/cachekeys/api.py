...
from rama.cachekeys.schemas import CacheInvalidationRequestSchema
from rama.connectors.sqla.models import SqlaTable
from rama.extensions import cache_manager, db, event_logger, stats_logger_manager
from rama.models.cache import CacheKey
from rama.views.base_api import BaseRamaModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class CacheRestApi(BaseRamaModelRestApi):
