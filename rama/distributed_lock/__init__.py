...
from rama.distributed_lock.utils import get_key
from rama.exceptions import CreateKeyValueDistributedLockFailedException
from rama.key_value.types import JsonKeyValueCodec, KeyValueResource
...
def KeyValueDistributedLock(  # pylint: disable=invalid-name  # noqa: N802
    ...
    **kwargs: Any,
    ...
    from rama.commands.distributed_lock.create import CreateDistributedLock
    from rama.commands.distributed_lock.delete import DeleteDistributedLock
    from rama.commands.distributed_lock.get import GetDistributedLock
