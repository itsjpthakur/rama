...
from rama import db
from rama.key_value.exceptions import KeyValueCreateFailedError
from rama.key_value.types import (
    KeyValueCodec,
    KeyValueResource,
    PickleKeyValueCodec,
)
from rama.key_value.utils import get_uuid_namespace
...
class RamaMetastoreCache(BaseCache):
    def __init__(
        self,
        namespace: UUID,
        codec: KeyValueCodec,
    ...
    def factory(
        ...
        if (
            ...
            logger.warning(
                "Using PickleKeyValueCodec with RamaMetastoreCache may be unsafe, "
