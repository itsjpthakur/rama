...
from rama.async_events.async_query_manager import AsyncQueryManager
from rama.async_events.async_query_manager_factory import AsyncQueryManagerFactory
from rama.extensions.ssh import SSHManagerFactory
from rama.extensions.stats_logger import BaseStatsLoggerManager
from rama.security.manager import RamaSecurityManager
from rama.utils.cache_manager import CacheManager
from rama.utils.encrypt import EncryptedFieldFactory
from rama.utils.feature_flag_manager import FeatureFlagManager
from rama.utils.machine_auth import MachineAuthProviderFactory
from rama.utils.profiler import RamaProfiler
...
class ProfilingExtension:  # pylint: disable=too-few-public-methods
    ...
    def init_app(self, app: Flask) -> None:
        app.wsgi_app = RamaProfiler(app.wsgi_app, self.interval)
...
security_manager: RamaSecurityManager = LocalProxy(lambda: appbuilder.sm)
