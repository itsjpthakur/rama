...
from rama.constants import LRU_CACHE_MAX_SIZE, NO_TIME_RANGE
...
class ExtraCache:
    ...
    def url_param(
        ...
        from rama.views.utils import get_form_data
...
def get_dataset_id_from_context(metric_key: str) -> int:
    ...
    from rama.views.utils import loads_request_json
    ...
    if form_data := (form_data or getattr(g, "form_data", {})):
        ...
        if chart_id := (form_data.get("slice_id") or url_params.get("slice_id")):
            ...
            if not chart_data:
                raise RamaTemplateException(exc_message)
...
def metric_macro(metric_key: str, dataset_id: Optional[int] = None) -> str:
    ...
    while has_metric_macro(definition, env):
        ...
        try:
            ...
            raise RamaTemplateException("Cyclic metric macro detected") from ex
