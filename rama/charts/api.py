...
from rama.charts.filters import (
    ChartAllTextFilter,
...
from rama.charts.schemas import (
    CHART_SCHEMAS,
...
from rama.commands.chart.create import CreateChartCommand
from rama.commands.chart.delete import DeleteChartCommand
...
from rama.commands.chart.export import ExportChartsCommand
from rama.commands.chart.fave import AddFavoriteChartCommand
from rama.commands.chart.importers.dispatcher import ImportChartsCommand
from rama.commands.chart.unfave import DelFavoriteChartCommand
from rama.commands.chart.update import UpdateChartCommand
from rama.commands.chart.warm_up_cache import ChartWarmUpCacheCommand
from rama.commands.exceptions import CommandException, TagForbiddenError
...
from rama.tasks.thumbnails import cache_chart_thumbnail
...
class ChartRestApi(BaseRamaModelRestApi):
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("Rama.slice", slice_id=chart.id)
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        url = get_url_path("Rama.slice", slice_id=chart.id)
