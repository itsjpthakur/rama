...
from rama.commands.dataset.create import CreateDatasetCommand
from rama.commands.dataset.delete import DeleteDatasetCommand
from rama.commands.dataset.duplicate import DuplicateDatasetCommand
...
from rama.commands.dataset.importers.dispatcher import ImportDatasetsCommand
from rama.commands.dataset.refresh import RefreshDatasetCommand
from rama.commands.dataset.update import UpdateDatasetCommand
from rama.commands.dataset.warm_up_cache import DatasetWarmUpCacheCommand
...
from rama.databases.filters import DatabaseFilter
from rama.datasets.filters import DatasetCertifiedFilter, DatasetIsNullOrEmptyFilter
from rama.datasets.schemas import (
...
from rama.exceptions import RamaTemplateException
from rama.jinja_context import BaseTemplateProcessor, get_template_processor
from rama.utils import json
from rama.utils.core import parse_boolean_string
from rama.views.base import DatasourceFilter
...
class DatasetRestApi(BaseRamaModelRestApi):
    ...
    def get(self, pk: int, **kwargs: Any) -> Response:
        ...
        if parse_boolean_string(request.args.get("include_rendered_sql")):
            ...
            except RamaTemplateException as ex:
