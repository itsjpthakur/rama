...
from rama.daos.user import UserDAO
from rama.utils.slack import get_user_avatar, SlackClientError
from rama.views.base_api import BaseRamaApi
from rama.views.users.schemas import UserResponseSchema
from rama.views.utils import bootstrap_user_data

user_response_schema = UserResponseSchema()


class CurrentUserRestApi(BaseRamaApi):
