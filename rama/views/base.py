...
from rama.connectors.sqla import models
...
from rama.reports.models import ReportRecipientType
from rama.rama_typing import FlaskResponse
from rama.translations.utils import get_language_pack
from rama.utils import core as utils, json
from rama.utils.filters import get_dataset_access_filters
from rama.views.error_handling import json_error_response

from .utils import bootstrap_user_data

FRONTEND_CONF_KEYS = (
    "RAMA_WEBSERVER_TIMEOUT",
    "RAMA_DASHBOARD_POSITION_DATA_LIMIT",
    "RAMA_DASHBOARD_PERIODICAL_REFRESH_LIMIT",
    "RAMA_DASHBOARD_PERIODICAL_REFRESH_WARNING_MESSAGE",
    "ENABLE_JAVASCRIPT_CONTROLS",
    "DEFAULT_SQLLAB_LIMIT",
    "DEFAULT_VIZ_TYPE",
    "SQL_MAX_ROW",
    "RAMA_WEBSERVER_DOMAINS",
...
def deprecated(
    ...
    """
    A decorator to set an API endpoint from RamaView has deprecated.
...
def get_environment_tag() -> dict[str, Any]:
    ...
    # default is RAMA_ENV (from FLASK_ENV in previous versions)
...
def menu_data(user: User) -> dict[str, Any]:
    ...
    return {
        ...
        "brand": {
            "path": appbuilder.app.config["LOGO_TARGET_PATH"] or "/rama/welcome/",
        ...
        "navbar_right": {
            ...
            "show_watermark": ("logo" not in appbuilder.app_icon),
...
class RamaListWidget(ListWidget):  # pylint: disable=too-few-public-methods
    template = "rama/fab_overrides/list.html"


class RamaModelView(ModelView):
    page_size = 100
    list_widget = RamaListWidget
