...
from rama import db, event_logger, is_feature_enabled
from rama.constants import MODEL_VIEW_RW_METHOD_PERMISSION_MAP, RouteMethod
from rama.models.dashboard import Dashboard as DashboardModel
...
from rama.views.dashboard.mixin import DashboardMixin


class DashboardModelView(DashboardMixin, RamaModelView, DeleteMixin):  # pylint: disable=too-many-ancestors
...
class Dashboard(BaseRamaView):
    ...
    def new(self) -> FlaskResponse:
        ...
        return redirect(f"/rama/dashboard/{new_dashboard.id}/?edit=true")
