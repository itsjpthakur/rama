...
from rama import event_logger, security_manager
from rama.constants import MODEL_API_RW_METHOD_PERMISSION_MAP
from rama.daos.log import LogDAO
...
from rama.views.log import LogMixin
from rama.views.log.schemas import (
...
class LogRestApi(LogMixin, BaseRamaModelRestApi):
