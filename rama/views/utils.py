...
from rama import app, dataframe, db, result_set, viz
...
from rama.extensions import cache_manager, feature_flag_manager, security_manager
from rama.legacy import update_time_range
...
from rama.rama_typing import FormData
...
def get_datasource_info(
    ...
    :raises RamaException: If the datasource no longer exists
    """
...
# /rama-frontend/src/dashboard/util/componentTypes.js
...
def check_explore_cache_perms(_self: Any, cache_key: str) -> None:
    ...
    :param _self: the Rama view instance
    ...
    **kwargs: Any,
    ...
    try:
        ...
        raise RamaSecurityException(
            RamaError(
                error_type=RamaErrorType.FAILED_FETCHING_DATASOURCE_INFO_ERROR,
    ...
    if datasource_type is None:
        raise RamaSecurityException(
            RamaError(
                error_type=RamaErrorType.UNKNOWN_DATASOURCE_TYPE_ERROR,
                level=ErrorLevel.ERROR,
...
def _deserialize_results_payload(
    ...
    if use_msgpack:
        ...
        df = result_set.RamaResultSet.convert_table_to_df(pa_table)
