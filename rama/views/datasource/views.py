...
from rama import db, event_logger, security_manager
from rama.commands.dataset.exceptions import (
    DatasetForbiddenError,
    DatasetNotFoundError,
)
from rama.commands.utils import populate_owner_list
from rama.connectors.sqla.models import SqlaTable
from rama.connectors.sqla.utils import get_physical_table_metadata
...
from rama.views.datasource.schemas import (
...
from rama.views.datasource.utils import get_samples
from rama.views.error_handling import handle_api_exception
from rama.views.utils import sanitize_datasource_data


class Datasource(BaseRamaView):
    ...
    def external_metadata_by_name(self, **kwargs: Any) -> FlaskResponse:
        ...
        try:
            if datasource is not None:
                # Get columns from Rama metadata
                external_metadata = datasource.external_metadata()
            else:
...
class DatasetEditor(BaseRamaView):
    route_base = "/dataset"
