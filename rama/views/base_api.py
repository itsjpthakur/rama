...
from rama.exceptions import InvalidPayloadFormatError
from rama.extensions import db, event_logger, security_manager, stats_logger_manager
from rama.models.core import FavStar
from rama.models.dashboard import Dashboard
from rama.models.slice import Slice
from rama.schemas import error_payload_content
from rama.sql_lab import Query as SqllabQuery
from rama.rama_typing import FlaskResponse
from rama.utils.core import get_user_id, time_function
...
def requires_json(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseRamaModelRestApi, *args: Any, **kwargs: Any) -> Response:
...
def requires_form_data(f: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def wraps(self: BaseRamaApiMixin, *args: Any, **kwargs: Any) -> Response:
...
def validate_feature_flags(
    ...
    def decorate(f: Callable[..., Response]) -> Callable[..., Response]:
        @functools.wraps(f)
        def wrapper(
            self: BaseRamaModelRestApi, *args: Any, **kwargs: Any
        ) -> Response:
...
class BaseRamaApi(BaseRamaApiMixin, BaseApi):
    pass


class BaseRamaModelRestApi(BaseRamaApiMixin, ModelRestApi):
    """
    Extends FAB's ModelResApi to implement specific rama generic functionality
    """
