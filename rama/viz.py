...
from rama.utils import core as utils, csv, json
from rama.utils.cache import set_and_log_cache
...
from rama.utils.date_parser import get_since_until, parse_past_timedelta
            ...
            try:
                ...
                error = dataclasses.asdict(
                    RamaError(
                        ...
                        error_type=RamaErrorType.VIZ_GET_DF_ERROR,
                    )
                )
                self.errors.append(error)
                self.status = QueryStatus.FAILED
...
class TimeTableViz(BaseViz):
    ...
    credits = 'a <a href="https://github.com/airbnb/rama">Rama</a> original'
    is_timeseries = True
...
class WorldMapViz(BaseViz):
    ...
    def get_data(self, df: pd.DataFrame) -> VizData:
        ...
        from rama.examples import countries
