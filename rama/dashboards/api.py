...
from rama import db
from rama.charts.schemas import ChartEntityResponseSchema
from rama.commands.dashboard.copy import CopyDashboardCommand
from rama.commands.dashboard.create import CreateDashboardCommand
from rama.commands.dashboard.delete import (
...
from rama.commands.dashboard.export import ExportDashboardsCommand
from rama.commands.dashboard.fave import AddFavoriteDashboardCommand
from rama.commands.dashboard.importers.dispatcher import ImportDashboardsCommand
from rama.commands.dashboard.permalink.create import CreateDashboardPermalinkCommand
from rama.commands.dashboard.unfave import DelFavoriteDashboardCommand
from rama.commands.dashboard.update import (
    UpdateDashboardColorsConfigCommand,
    UpdateDashboardCommand,
    UpdateDashboardNativeFiltersCommand,
)
from rama.commands.database.exceptions import DatasetValidationError
from rama.commands.exceptions import TagForbiddenError
from rama.commands.importers.exceptions import NoValidFilesFoundError
from rama.commands.importers.v1.utils import get_contents_from_bundle
...
from rama.dashboards.filters import (
...
from rama.dashboards.permalink.types import DashboardPermalinkState
from rama.dashboards.schemas import (
...
from rama.models.embedded_dashboard import EmbeddedDashboard
from rama.security.guest_token import GuestUser
from rama.tasks.thumbnails import (
    cache_dashboard_screenshot,
    cache_dashboard_thumbnail,
)
from rama.tasks.utils import get_current_user
from rama.utils import json
from rama.utils.core import parse_boolean_string
from rama.utils.pdf import build_pdf_from_screenshots
from rama.utils.screenshots import (
    DashboardScreenshot,
...
from rama.views.error_handling import handle_api_exception
from rama.views.filters import (
...
def with_dashboard(
    f: Callable[[BaseRamaModelRestApi, Dashboard], Response],
) -> Callable[[BaseRamaModelRestApi, str], Response]:
    """
    ...
    def wraps(self: BaseRamaModelRestApi, id_or_slug: str) -> Response:
        try:
...
class DashboardRestApi(BaseRamaModelRestApi):
    ...
    def __repr__(self) -> str:
        ...
        return "Rama.dashboards.api.DashboardRestApi@v{}{}".format(
    ...
    def cache_dashboard_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        dashboard_url = get_url_path("Rama.dashboard_permalink", key=permalink_key)
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        dashboard_url = get_url_path(
            "Rama.dashboard", dashboard_id_or_slug=dashboard.id
        )
