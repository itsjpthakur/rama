...
from rama.dashboards.permalink.exceptions import DashboardPermalinkInvalidStateError
from rama.dashboards.permalink.schemas import DashboardPermalinkStateSchema
from rama.extensions import event_logger
from rama.key_value.exceptions import KeyValueAccessDeniedError
from rama.views.base_api import BaseRamaApi, requires_json

logger = logging.getLogger(__name__)


class DashboardPermalinkRestApi(BaseRamaApi):
    ...
    def post(self, pk: str) -> Response:
        ...
        try:
            ...
            url = url_for("Rama.dashboard_permalink", key=key, _external=True)
