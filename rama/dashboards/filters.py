...
from rama.models.dashboard import Dashboard, is_uuid
from rama.models.embedded_dashboard import EmbeddedDashboard
from rama.models.slice import Slice
from rama.security.guest_token import GuestTokenResourceType, GuestUser
from rama.tags.filters import BaseTagIdFilter, BaseTagNameFilter
from rama.utils.core import get_user_id
from rama.utils.filters import get_dataset_access_filters
from rama.views.base import BaseFilter
from rama.views.base_api import BaseFavoriteFilter
...
class DashboardAccessFilter(BaseFilter):  # pylint: disable=too-few-public-methods
    ...
    def apply(self, query: Query, value: Any) -> Query:
        ...
        if is_feature_enabled("EMBEDDED_RAMA") and security_manager.is_guest_user(
            g.user
        ):
