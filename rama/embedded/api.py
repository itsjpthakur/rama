...
from rama.dashboards.schemas import EmbeddedDashboardResponseSchema
from rama.extensions import event_logger
from rama.models.embedded_dashboard import EmbeddedDashboard
from rama.reports.logs.schemas import openapi_spec_methods_override
from rama.views.base_api import BaseRamaModelRestApi, statsd_metrics

logger = logging.getLogger(__name__)


class EmbeddedDashboardRestApi(BaseRamaModelRestApi):
