...
if [ "$BUILD_RAMA_FRONTEND_IN_DOCKER" = "true" ]; then
    echo "Building Rama frontend in dev mode inside docker container"
    cd /app/rama-frontend
    ...
    echo "https://github.com/imajpsingh/rama"
fi
